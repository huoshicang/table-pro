...
const columns: TableColumn<RowData>[] = [
  ...
  },
  {
    ...
    meta: { type: 'date', placeholder: '请选择日期', valueFormat: 'YYYY-MM-DD' },
  },
  {
    key: 'leaveType',
    title: '请假类别',
...
function handleDelete(record: RowData) {
  console.log(`[antd] 删除：`, record)
}

function handleSearch(values: Record<string, unknown>) {
  console.log('[antd] 搜索:', values)
}
